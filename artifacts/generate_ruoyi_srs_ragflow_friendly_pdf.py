...
SOURCE = BASE_DIR / "ruoyi-user-management-srs-v2-regenerated-ragflow-friendly.md"
OUTPUT = BASE_DIR / "ruoyi-user-management-srs-v2-regenerated-ragflow-friendly.pdf"
