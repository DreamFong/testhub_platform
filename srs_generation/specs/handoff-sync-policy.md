...
本文档用于定义 `specs/`、portable skill references、run handoff、`current-work-summary.md` 和 `session-handoff.md` 之间的角色边界与同步规则。

## 2. Canonical handoff 定义

当前阶段的 canonical handoff，是被 `current-work-summary.md` 与 `session-handoff.md` 明确引用、且代表最新有效阶段结论的 handoff 文件。

当前 canonical handoff 示例：
...
- 当前 canonical handoff 改变：更新 `current-work-summary.md` 与 `session-handoff.md`。
...
- portable skill references 仅在对应 repo spec 更新后同步，不应单独修订语义。
